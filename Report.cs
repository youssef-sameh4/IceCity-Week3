    ...
    public void PrintReport(Owner owner, House house)
    {
        ...
        Console.WriteLine("\n--- Printing Usage Using Threads ---\n");
        service.PrintUsingThread(house.dailyUsages);
        Console.WriteLine("\n--- Printing Weather Records Using Tasks ---");
        var printTask = service.PrintUsingTask(house.dailyUsages);
        printTask.Wait();
        Console.WriteLine("==============================================");
        Task task = service.GetLastMonthWeatherAsync();
           task.Wait();
